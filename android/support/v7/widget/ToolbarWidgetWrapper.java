...
public class ToolbarWidgetWrapper implements DecorToolbar {
    ...
    class C02152 extends ViewPropertyAnimatorListenerAdapter {
    ...
    public ViewPropertyAnimatorCompat setupAnimatorToVisibility(int visibility, long duration) {
        return ViewCompat.animate(this.mToolbar).alpha(visibility == 0 ? 1.0f : 0.0f).setDuration(duration).setListener(new C02152(visibility));
    }
